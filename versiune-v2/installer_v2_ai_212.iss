...
OutputBaseFilename=KID-Diagnostic-V2-AI-v2.1.2-Setup
Compression=lzma2
...
[Run]
Filename: "{app}\{#MyAppExeName}"; Description: "Pornește KID Diagnostic V2 v2.1.2"; Flags: nowait postinstall skipifsilent
